...
public class UserAccountRegistrationService {
	...
	public User_account_informations_DTO userRegistrationAccount(User_personnal_informations_DTO user_personnal_informations_dto ) {
		...
		user_account_informations_DTO.setAccount_reference_transaction(attributeAccount_reference_transaction(user_personnal_informations_dto));
		
		return user_account_informations_DTO;
	}
	
	private String attributeAccount_reference_transaction(User_personnal_informations_DTO user_personnal_informations_dto) {
